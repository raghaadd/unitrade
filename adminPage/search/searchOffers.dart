...
import 'package:flutter_project_1st/adminPage/offers/offerDetailsAdmin.dart';
import 'package:flutter_project_1st/generated/l10n.dart';
import 'package:flutter_project_1st/ipaddress.dart';
import 'package:http/http.dart' as http;

class searchOffers extends StatefulWidget {
  const searchOffers({super.key});

  @override
  State<searchOffers> createState() => _searchOffersState();
}
...
class _searchOffersState extends State<searchOffers> {
  ...
  Future<List<Map<String, dynamic>>> seaechResult() async {
    ...
    final String apiUrl = "http://$ipAddress:3000/searchoffers";
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => Card(
                  key: ValueKey(_founditems[index]["idofferNames"]),
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => offerDetailsAdmin(
                                    offerDetailID: _founditems[index]
                                        ["idofferNames"],
                                  )));
                    },
                    child: ListTile(
                      leading: ClipRRect(
                          ...
                          child: Image.asset(
                            offers[_founditems[index]["idoffers"] - 1]["image"],
                            width: 100,
                            height: 60,
                            fit: BoxFit.cover,
                          )),
                      title: Text(
                        _founditems[index]['offerDetails'] +
                            " :" +
                            offers[_founditems[index]["idoffers"] - 1]["name"],
                        style: TextStyle(
                            fontSize: 20,
                      ...
                      subtitle: Text(
                        '${_founditems[index]["phoneNumber"].toString()}\n${_founditems[index]["discount"]}%',
                        style: TextStyle(
                            color: Color(0xFF000000),
                            fontSize: 16,
