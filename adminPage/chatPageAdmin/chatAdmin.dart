...
import 'package:flutter_project_1st/adminPage/chatPageAdmin/AdminItem.dart';
...
class chatAdmin extends StatefulWidget {
  ...
  @override
  State<chatAdmin> createState() => _chatpageState();
}

class _chatpageState extends State<chatAdmin> with TickerProviderStateMixin {
  String errorMessage = '';
  String receiverId = '';
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) =>
                    adminItem(user: userData[index], registerId: registerid,themeProvider:themeProvider),
              ),
            ),
          ],
        ));
