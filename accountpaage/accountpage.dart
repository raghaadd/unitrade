...
class _AccountPageState extends State<AccountPage> {
                        ...
                        return AlertDialog(
                          content: Column(
                            ...
                            children: [
                              ...
                              CustomAlertContent(
                                  alertText:
                                      S.of(context).select_type_of_item,),
                              SizedBox(height: 16),
                              Row(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(
            ...
            style: TextStyle(
              ...
              height: 1.4,
              color:
                  themeProvider.isDarkMode ? Color(0xFFffffff) : Colors.black45,
            ),
          ),
        ]),
      );
  ...
  // buildReservation(themeProvider) {
  //   return Container(
  ...
  //             fontSize: 22,
  //             color:
  //                 themeProvider.isDarkMode ? Color(0xFFffffff) : Colors.black,
  //           ),
  //         ),
  //         Row(
  //           mainAxisAlignment: MainAxisAlignment.spaceBetween,
  ...
  //             //     border: Border.all(
  //             //       color: Color(0xFFd6d6d6).withOpacity(0.6),
  //             //       width: 2,
  //             //     ),
  //             //   ),
  //             //   child: Text(
                                              ...
                                              MaterialPageRoute(
                                                builder: (context) => editPost(
                                                  itemTitle: items[index]
                                                      ["title"],
                                                  itemPrice: items[index]
                                                      ["price"],
                                                  itemStatus: items[index]
                                                      ["status"],
