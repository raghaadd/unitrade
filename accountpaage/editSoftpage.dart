...
class editSoftSlides extends StatefulWidget {
  editSoftSlides(
      {super.key,
  ...
  @override
  State<editSoftSlides> createState() => _AccountScreenState();
}

class _AccountScreenState extends State<editSoftSlides> {
        ...
        child: GestureDetector(
          ...
          child: ListView(
            children: [
              ...
              buildTextField(
                  "Title", widget.itemTitle, titleController, themeProvider),
              buildTextField("Description", widget.itemDescription,
